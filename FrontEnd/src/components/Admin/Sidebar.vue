        ...
        <ul>
          <li class="submenu-open">
            ...
            <ul>
                ...
                <ul>
                  ...
                  <li>
                    <router-link to="sales-dashboard"><i data-feather="shopping-bag"></i><span>Sales Dashboard</span></router-link>
                  </li>
                </ul>
          ...
          <li class="submenu-open">
            ...
            <ul>
              ...
              <li>
                <router-link to="create-product"><i data-feather="plus-square"></i><span>Create Product</span></router-link>
              </li>
             
              <li>
                <router-link to="low-stocks"><i data-feather="trending-down"></i><span>Low Stocks</span></router-link>
              </li>
              <li>
                <router-link to="category"><i data-feather="codepen"></i><span>Category</span></router-link>
              </li>
              <li>
                <router-link to="sub-categories"><i data-feather="speaker"></i><span>Sub Category</span></router-link>
              </li>
              <li>
              ...
              <li>
                <router-link to="barcode"><i data-feather="align-justify"></i><span>Print Barcode</span></router-link>
              </li>
          ...
          <li class="submenu-open">
            ...
            <ul>
              <li>
                <router-link to="sales-report"><i data-feather="bar-chart-2"></i><span>Sales Report</span></router-link>
              </li>
              <li>
                <router-link to="purchase-report"><i data-feather="pie-chart"></i><span>Purchase report</span></router-link>
              </li>
              <li>
                <router-link to="inventory-report"><i data-feather="inbox"></i><span>Inventory Report</span></router-link>
              </li>
              <li>
                <router-link to="invoice-report"><i data-feather="file"></i><span>Invoice Report</span></router-link>
              </li>
              <li>
                <router-link to="customer-report"><i data-feather="user"></i><span>Customer Report</span></router-link>
              </li>
              <li>
                <router-link to="expense-report"><i data-feather="file"></i><span>Return Report</span></router-link>
              </li>
              <li>
                <router-link to="income-report"><i data-feather="bar-chart"></i><span>Income Report</span></router-link>
              </li>
              <li>
                <router-link to="tax-reports"><i data-feather="database"></i><span>Tax Report</span></router-link>
              </li>
              <li>
                <router-link to="profit-and-loss"><i data-feather="pie-chart"></i><span>Profit & Loss</span></router-link>
              </li>
            </ul>
          </li>
          <li class="submenu-open">
      ...
      <div id="sidebar-menu-2" class="sidebar-menu sidebar-menu-three">
        <aside id="aside" class="ui-aside">
          <ul class="tab nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <a class="tablinks nav-link" href="#profile" id="profile-tab" data-bs-toggle="tab" data-bs-target="#sales"
            ...
            <li class="nav-item" role="presentation">
              <a class="tablinks nav-link" href="#set" id="set-tab" data-bs-toggle="tab" data-bs-target="#user"
                role="tab" aria-selected="true">
                <img src="assets/img/icons/users1.svg" alt />
              </a>
            </li>
            <li class="nav-item" role="presentation">
              <a class="tablinks nav-link" href="#set2" id="set-tab2" data-bs-toggle="tab" data-bs-target="#employee"
                role="tab" aria-selected="true">
                <img src="assets/img/icons/calendars.svg" alt />
              </a>
            </li>
            <li class="nav-item" role="presentation">
              <a class="tablinks nav-link" href="#set3" id="set-tab3" data-bs-toggle="tab" data-bs-target="#report"
                role="tab" aria-selected="true">
                <img src="assets/img/icons/printer.svg" alt />
              </a>
            </li>
            <li class="nav-item" role="presentation">
              <a class="tablinks nav-link" href="#set4" id="set-tab4" data-bs-toggle="tab" data-bs-target="#document"
                role="tab" aria-selected="true">
                <i data-feather="file-minus"></i>
              </a>
            </li>
            <li class="nav-item" role="presentation">
              <a class="tablinks nav-link" href="#set5" id="set-tab6" data-bs-toggle="tab" data-bs-target="#permission"
                role="tab" aria-selected="true">
                <i data-feather="user"></i>
              </a>
            </li>
            <li class="nav-item" role="presentation">
              <a class="tablinks nav-link" href="#set6" id="set-tab5" data-bs-toggle="tab" data-bs-target="#settings"
                role="tab" aria-selected="true">
        ...
        <div class="tab-content tab-content-four pt-2">
          ...
          <ul class="tab-pane" id="report" aria-labelledby="set-tab3">
            ...
            <li>
              <a href="invoice-report"><span>Invoice Report</span></a>
            </li>
            <li>
              <a href="supplier-report"><span>Supplier Report</span></a>
            </li>
            <li>
              <a href="customer-report"><span>Customer Report</span></a>
            </li>
            <li>
              <a href="expense-report"><span>Expense Report</span></a>
            </li>
            <li>
              <a href="income-report"><span>Income Report</span></a>
            </li>
            <li>
              <a href="tax-reports"><span>Tax Report</span></a>
            </li>
            <li>
              <a href="profit-and-loss"><span>Profit & Loss</span></a>
            </li>
          </ul>
          <ul class="tab-pane" id="permission" aria-labelledby="set-tab4">
            ...
            <li>
              <a href="roles-permissions"><span>Roles & Permissions</span></a>
            </li>
            <li>
              <a href="delete-account"><span>Delete Account Request</span></a>
            </li>
            <li class="submenu">
