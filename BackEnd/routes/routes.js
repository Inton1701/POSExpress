...
// Kiosk routes
router.route("/api/kiosk/products").get((req, res) => KioskController.getProducts(req, res));
router.route("/api/kiosk/product/:id").get((req, res) => KioskController.getProductDetails(req, res));
router.route("/api/kiosk/order").post((req, res) => KioskController.placeOrder(req, res));
router.route("/api/kiosk/order/:id").get((req, res) => KioskController.getOrderDetails(req, res));
router.route("/api/kiosk/order/history/:userId").get((req, res) => KioskController.getOrderHistory(req, res));
