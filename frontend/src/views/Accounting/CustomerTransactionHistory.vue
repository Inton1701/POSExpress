...
import { faPrint, faFileExcel, faBan, faIdCard, faKeyboard, faExpand, faBackspace } from '@fortawesome/free-solid-svg-icons'

library.add(faPrint, faFileExcel, faBan, faIdCard, faKeyboard, faExpand, faBackspace)
